...
def injection_types_plot(file):
    ...
    grouped_df['masked_percent'] = (grouped_df['masked'] / total_injections) * 100
    grouped_df['non_critical_percent'] = (grouped_df['non_critical'] / total_injections) * 100
    ...
    grouped_df.plot(kind='bar', stacked=True, title='Percentage of Injection Types', ylabel='Percentage', xlabel='Layer', figsize=(10, 6))
